...
void PrintList(LinkList L);                         //遍历输出函数
void Insert(LinkList& L);                           //插入功能函数 调用ListInsert后插
void Delete(LinkList L);                            //删除功能函数 调用ListDelete删除
void Search(LinkList L);                             //查找功能函数 调用LocateElem查找
void SingleListMenu();
